                ...
                <section class="text-gray-600 body-font relative">
                  <div class="container px-5mx-auto">
                    ...
                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                      <form action="{{ route('family.image.update', ['image' => $image->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <!-- Validation Errors -->
                        ...
                        <div class="-m-2">
                          ...
                          <div class="p-2 w-1/2 mx-auto">
                            <div class="relative">
                              ...
                              <textarea id="message" name="message" value="{{ $image->message }}"  class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                              </textarea>
                            </div>
                          </div>
                          ...
                          <div class="p-2 w-1/2 mx-auto">
                            <div class="relative">
                              ...
                              <input type="text" id="image_title" name="image_title" value="{{ $image->image_title }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
                          </div>

                          <div class="p-2 w-full mt-4 flex justify-around">
                            <button type="button" onclick="location.href='{{ route('family.image.index') }}'" class="text-white bg-gray-300 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">戻る</button>
