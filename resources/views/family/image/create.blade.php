                        ...
                        <div class="-m-2">
                          ...
                          <div class="p-2 w-1/2 mx-auto">
                            <div class="relative">
                              ...
                              <input type="file" accept="image/png, image/jpeg, image/jpg" id="image1" name="image1" class="w-full py-1 px-3 leading-8">
                            </div>
                          </div>
                          <div class="p-2 w-1/2 mx-auto">
                            <div class="relative">
                              <label for="password_confirmation" class="leading-7 text-sm text-gray-600">画像タイトル</label>
